...
class detect_bar_code_ddn:
    ...
    def detect_bar_code_ddn(this, X, is_training):
            ...
            conv_layer_1_1 = this.create_new_conv_layer(conv_layer_1, 16, 16, [1, 1], [1, 1, 1, 1], True,  True, is_training, name='layer1_max')
            ...
            conv_layer_3 = this.create_new_conv_layer(conv_layer_2, 8, 1, [4, 4], [1,1,1,1], True,  True, is_training, name='layer3')
            ...
            conv_layer_4 = this.create_new_conv_layer(conv_layer_3, 1, 1, [1, 1], [1,1,1,1], False,  False, is_training, name='layer4')

...
with tf.name_scope("dnn"):
    ...
    conv_layer_1 = create_new_conv_layer(X, 3, 128, [10, 10], [1, 1, 1, 1], True, True, is_training, name='layer1')
    ...
    conv_layer_1_1 = create_new_conv_layer(conv_layer_1, 128, 128, [1, 1], [1, 1, 1, 1], True,  True, is_training, name='layer1_max')
    ...
    conv_layer_2 = create_new_conv_layer(max_pool_1, 128, 64, [4, 4], [1,1,1,1], True,  True, is_training, name='layer2')
    ...
    conv_layer_3 = create_new_conv_layer(conv_layer_2, 64, 1, [4, 4], [1,1,1,1], True,  True, is_training, name='layer3')
